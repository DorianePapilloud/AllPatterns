...
import Ex1.Components.ConcreteComponentCarBerlin;
import Ex1.Components.ConcreteComponentCarBreak;
import Ex1.Components.ConcreteComponentCarSport;
import Ex1.Decorators.*;

public class TestCar {

    public static void main(String[] args) {
        TestCar launcher = new TestCar();
        launcher.launch();
    }
